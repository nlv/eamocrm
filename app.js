...
var $author$project$App$getLeads = $elm$http$Http$get(
	{
...
var $author$project$App$refreshButton = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$App$RefreshLeads)
		]),
	_List_fromArray(
		[
...
var $author$project$App$rowView = function (lead) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(lead.id))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href(lead.href)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(lead.href)
							]))
					])),
				A2(
				$elm$html$Html$td,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(lead.address)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(lead.sellCost))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(lead.partsCost))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(lead.worksCost))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(lead.officeIncome))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(lead.statusId))
					]))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Номер заявки')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Ссылка на заявку')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Дата выезда')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Адрес заявки')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Цена клиенту')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Затраты на матерал')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Стоимость работ для клиента')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Перевод в офис')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Дата закрытия')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Статус заявки')
									]))
							])),
						A2(
						$elm$html$Html$tbody,
						_List_Nil,
						A2($elm$core$List$map, $author$project$App$rowView, leads))
					]))
			]));
};
